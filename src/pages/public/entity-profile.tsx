...
export function PublicEntityProfilePage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Cover Image */}
      <div className="relative h-64 sm:h-80 bg-gradient-to-br from-primary/20 via-primary/10 to-background overflow-hidden">
        {entity.coverImage ? (
          <img
        ...
        <Button
          variant="ghost"
          size="sm"
          className="absolute top-4 left-4 bg-white/10 backdrop-blur-sm hover:bg-white/20 text-white border border-white/20"
          onClick={() => navigate("/")}
        >
          <ArrowLeft className="h-4 w-4 mr-2" />
          Back
        ...
        <div className="relative z-10 bg-card rounded-lg shadow-xl p-6 mb-8">
          <div className="flex flex-col sm:flex-row gap-6 items-start">
            ...
            <Avatar className="h-28 w-28 sm:h-32 sm:w-32 border-4 border-background shadow-lg shrink-0">
              ...
              <AvatarFallback className="text-2xl sm:text-3xl bg-gradient-to-br from-blue-500 to-purple-500 text-white">
            ...
            <div className="flex-1 min-w-0 w-full">
              ...
              <div className="flex flex-wrap items-center gap-3 sm:gap-4 text-sm sm:text-base text-muted-foreground mb-4">
                <div className="flex items-center gap-2">
                  ...
                  <span className="break-words">{entity.address}</span>
                </div>
                <div className="flex items-center gap-2">
