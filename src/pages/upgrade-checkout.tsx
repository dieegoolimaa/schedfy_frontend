...
export function UpgradeCheckoutPage() {
    ...
    // Define plan details mapping using dynamic pricing
    const getPlanDetails = (id: string | null) => {
        if (!id) return null;

        // Get dynamic price from Region Context
        const price = getPriceDisplay(id as any, "monthly");

        const plans: Record<string, any> = {
            "simple": {
                name: t("plans.simple.name", "Simple"),
                description: t("plans.simple.description", "Perfect for solo professionals"),
                features: [
                    t("plans.simple.features.appointments", "Up to 50 appointments/mo"),
                    t("plans.simple.features.calendar", "Basic calendar integration"),
            ...
            "individual": {
                ...
                description: t("plans.individual.description", "For growing professionals"),
                features: [
                    ...
                    t("plans.individual.features.forms", "Custom booking forms")
                ]
            },
            "business": {
